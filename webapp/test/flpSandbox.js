		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hola Mundo",
									"targetURL": "#globantholamundo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"globantholamundo-display": {
								"semanticObject": "globantholamundo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=globant.holamundo",
									"url": sap.ui.require.toUrl("globant/holamundo")
								}
							}
						}
					}
